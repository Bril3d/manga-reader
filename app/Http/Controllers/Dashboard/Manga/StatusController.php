...
class StatusController extends Controller
{
    ...
    {
        $this->middleware('can:viewAny,' . Taxonomy::class)->only('index');
        $this->middleware('can:create,' . Taxonomy::class)->only(['create', 'store']);
        $this->middleware('can:update,taxonomy')->only(['edit', 'update']);
        $this->middleware('can:delete,taxonomy')->only('delete');
    }
    ...
    {
        $statusQuery = Taxonomy::query()->where('type', 'manga_status');
    ...
    {
        $status = Taxonomy::where('type', 'manga_status')->findOrFail($id);
