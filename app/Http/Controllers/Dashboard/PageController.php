...
class PageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', __('Page has been created'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect(route('dashboard.pages.deleted'))->with('success', __('Page has been restored'));
    }
    ...
    public function hard_delete($id)
    {
        ...
        return redirect(route('dashboard.pages.deleted'))->with('success', __('Page has been permanently deleted'));
    }
}
