...
<head>
    ...
    <script>
        const language = {
            ...
            , "Users Registered": "{{ __('Users Registered') }}"
            , "Mangas Views": "{{ __('Mangas Views') }}"
            , "Chapters Views": "{{ __('Chapters Views') }}"
        };

    </script>
    @vite(['themes/'. config('theme.active') .'/css/app.css', 'themes/'. config('theme.active') .'/js/app.js', 'resources/js/dashboard.js'])
</head>
