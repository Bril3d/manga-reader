...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        settings()->set('theme.slider', 'active');
        ...
        settings()->set('seo.chapter.description', 'manga :manga translated , :manga translated , all chapters of :manga translated, chapter :chapter translated , :chapter translated');
