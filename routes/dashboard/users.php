...
Route::prefix('users')->group(
    function () {
        ...
        Route::get('/restore/{id}', [UserController::class, 'restore'])->middleware(['permission:restore_deleted_users'])->name('dashboard.users.restore');
        Route::get('/deleted/delete/{id}', [UserController::class, 'hard_delete'])->middleware(['permission:restore_deleted_users'])->name('dashboard.users.hard_delete');
    }
);
