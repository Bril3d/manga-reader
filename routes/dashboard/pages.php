...
Route::prefix('pages')->group(
    function () {
        ...
        Route::get('/trash', [PageController::class, 'deleted'])->middleware(['permission:restore_deleted_pages'])->name('dashboard.pages.deleted');
        Route::get('/trash/restore/{id}', [PageController::class, 'restore'])->middleware(['permission:restore_deleted_pages'])->name('dashboard.pages.restore');
        Route::get('/trash/delete/{page}', [PageController::class, 'hard_delete'])->middleware(['permission:restore_deleted_pages'])->name('dashboard.pages.hard_delete');
    }
);
